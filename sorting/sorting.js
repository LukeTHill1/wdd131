...
function searchHike(list, q) {
    function searchCallbacks(item) {
      return (
    ...
    const filtered = list.filter(searchCallbacks);

    const sorted = filtered.sort((a, b) => a.distance > b.distance);
    return sorted;
}
console.log(searchHike(hikes, "yellowstone"));
console.log(searchHike(hikes, "waterfall"));
console.log(searchHike(hikes, "al"));
console.log("======================================");